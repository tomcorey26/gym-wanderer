...
exports.FetchGymsDocument = graphql_tag_1.default(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n    query FetchGyms {\n  gyms {\n    ...gymInfo\n  }\n}\n    ", ""], ["\n    query FetchGyms {\n  gyms {\n    ...gymInfo\n  }\n}\n    ", ""])), exports.GymInfoFragmentDoc);
/**
...
exports.GymDetailsDocument = graphql_tag_1.default(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n    query gymDetails($id: String) {\n  gymDetails(id: $id) {\n    owner_id: id\n    owner_first_name: first_name\n    owner_last_name: last_name\n    email\n    owner_photo_url: photo_url\n    gym {\n      ...gymInfo\n    }\n  }\n  gymReviews(gymId: $id) {\n    rating\n    text\n    date_created\n    creator {\n      id\n      first_name\n      last_name\n      photo_url\n    }\n  }\n  gymMemberships(gymId: $id) {\n    member {\n      id\n      first_name\n      last_name\n      photo_url\n    }\n  }\n  me {\n    id\n  }\n}\n    ", ""], ["\n    query gymDetails($id: String) {\n  gymDetails(id: $id) {\n    owner_id: id\n    owner_first_name: first_name\n    owner_last_name: last_name\n    email\n    owner_photo_url: photo_url\n    gym {\n      ...gymInfo\n    }\n  }\n  gymReviews(gymId: $id) {\n    rating\n    text\n    date_created\n    creator {\n      id\n      first_name\n      last_name\n      photo_url\n    }\n  }\n  gymMemberships(gymId: $id) {\n    member {\n      id\n      first_name\n      last_name\n      photo_url\n    }\n  }\n  me {\n    id\n  }\n}\n    ", ""])), exports.GymInfoFragmentDoc);
/**
...
exports.HelloDocument = graphql_tag_1.default(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n    query Hello {\n  hello\n}\n    "], ["\n    query Hello {\n  hello\n}\n    "])));
/**
 * __useHelloQuery__
 *
...
exports.LoginDocument = graphql_tag_1.default(templateObject_18 || (templateObject_18 = __makeTemplateObject(["\n    mutation Login($username: String!, $password: String!) {\n  login(username: $username, password: $password) {\n    accessToken\n    user {\n      ...profile\n      preferences {\n        yoga\n        crossfit\n        bodybuilding\n        parkour\n        general\n        boxing\n      }\n      gym {\n        id\n        gym_name\n      }\n      ...alerts\n    }\n  }\n}\n    ", "\n", ""], ["\n    mutation Login($username: String!, $password: String!) {\n  login(username: $username, password: $password) {\n    accessToken\n    user {\n      ...profile\n      preferences {\n        yoga\n        crossfit\n        bodybuilding\n        parkour\n        general\n        boxing\n      }\n      gym {\n        id\n        gym_name\n      }\n      ...alerts\n    }\n  }\n}\n    ", "\n", ""])), exports.ProfileFragmentDoc, exports.AlertsFragmentDoc);
/**
...
exports.LogoutDocument = graphql_tag_1.default(templateObject_19 || (templateObject_19 = __makeTemplateObject(["\n    mutation Logout {\n  logout\n}\n    "], ["\n    mutation Logout {\n  logout\n}\n    "])));
/**
...
exports.MeDocument = graphql_tag_1.default(templateObject_20 || (templateObject_20 = __makeTemplateObject(["\n    query Me {\n  me {\n    ...profile\n    preferences {\n      yoga\n      crossfit\n      bodybuilding\n      parkour\n      general\n      boxing\n    }\n    gym {\n      id\n      gym_name\n    }\n    ...alerts\n  }\n}\n    ", "\n", ""], ["\n    query Me {\n  me {\n    ...profile\n    preferences {\n      yoga\n      crossfit\n      bodybuilding\n      parkour\n      general\n      boxing\n    }\n    gym {\n      id\n      gym_name\n    }\n    ...alerts\n  }\n}\n    ", "\n", ""])), exports.ProfileFragmentDoc, exports.AlertsFragmentDoc);
/**
 * __useMeQuery__
 *
...
exports.MyGymDocument = graphql_tag_1.default(templateObject_21 || (templateObject_21 = __makeTemplateObject(["\n    query MyGym {\n  myGym {\n    ...gymInfo\n  }\n}\n    ", ""], ["\n    query MyGym {\n  myGym {\n    ...gymInfo\n  }\n}\n    ", ""])), exports.GymInfoFragmentDoc);
/**
 * __useMyGymQuery__
 *
...
exports.UserProfileDocument = graphql_tag_1.default(templateObject_23 || (templateObject_23 = __makeTemplateObject(["\n    query userProfile($userId: String!) {\n  getUser(id: $userId) {\n    ...profile\n    preferences {\n      yoga\n      crossfit\n      bodybuilding\n      parkour\n      general\n      boxing\n    }\n    gym {\n      id\n      gym_name\n    }\n  }\n  userMemberships(userId: $userId) {\n    gym {\n      id\n      gym_name\n      location\n      type\n      photo_urls\n    }\n  }\n  userReviews(userId: $userId) {\n    rating\n    text\n    gym {\n      id\n      gym_name\n    }\n  }\n}\n    ", ""], ["\n    query userProfile($userId: String!) {\n  getUser(id: $userId) {\n    ...profile\n    preferences {\n      yoga\n      crossfit\n      bodybuilding\n      parkour\n      general\n      boxing\n    }\n    gym {\n      id\n      gym_name\n    }\n  }\n  userMemberships(userId: $userId) {\n    gym {\n      id\n      gym_name\n      location\n      type\n      photo_urls\n    }\n  }\n  userReviews(userId: $userId) {\n    rating\n    text\n    gym {\n      id\n      gym_name\n    }\n  }\n}\n    ", ""])), exports.ProfileFragmentDoc);
/**
...
exports.UsersDocument = graphql_tag_1.default(templateObject_24 || (templateObject_24 = __makeTemplateObject(["\n    query Users {\n  users {\n    ...profile\n  }\n}\n    ", ""], ["\n    query Users {\n  users {\n    ...profile\n  }\n}\n    ", ""])), exports.ProfileFragmentDoc);
/**
 * __useUsersQuery__
 *
