...
exports.ToggleAlertOffDocument = graphql_tag_1.default(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n    mutation ToggleAlertOff($alertId: Int!) {\n  toggleAlertOff(alertId: $alertId)\n}\n    "], ["\n    mutation ToggleAlertOff($alertId: Int!) {\n  toggleAlertOff(alertId: $alertId)\n}\n    "])));
/**
 ...
 * });
 */
function useToggleAlertOffMutation(baseOptions) {
    return ApolloReactHooks.useMutation(exports.ToggleAlertOffDocument, baseOptions);
}
exports.useToggleAlertOffMutation = useToggleAlertOffMutation;
exports.ToggleAllAlertsOffDocument = graphql_tag_1.default(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n    mutation ToggleAllAlertsOff {\n  toggleAllAlertsOff\n}\n    "], ["\n    mutation ToggleAllAlertsOff {\n  toggleAllAlertsOff\n}\n    "])));
/**
...
exports.UserMembershipsInfoDocument = graphql_tag_1.default(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n    query UserMembershipsInfo {\n  myMemberships {\n    memberId: id\n    myGymMemberships: gym {\n      id\n    }\n  }\n  myGym {\n    id\n  }\n}\n    "], ["\n    query UserMembershipsInfo {\n  myMemberships {\n    memberId: id\n    myGymMemberships: gym {\n      id\n    }\n  }\n  myGym {\n    id\n  }\n}\n    "])));
/**
...
exports.ByeDocument = graphql_tag_1.default(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n    query Bye {\n  bye\n}\n    "], ["\n    query Bye {\n  bye\n}\n    "])));
/**
 * __useByeQuery__
 *
...
exports.CreateReviewDocument = graphql_tag_1.default(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n    mutation createReview($text: String!, $rating: Float!, $gymId: String!) {\n  createReview(text: $text, rating: $rating, gymId: $gymId)\n}\n    "], ["\n    mutation createReview($text: String!, $rating: Float!, $gymId: String!) {\n  createReview(text: $text, rating: $rating, gymId: $gymId)\n}\n    "])));
/**
...
exports.DeleteReviewDocument = graphql_tag_1.default(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n    mutation DeleteReview($reviewId: Float!) {\n  deleteReview(reviewId: $reviewId)\n}\n    "], ["\n    mutation DeleteReview($reviewId: Float!) {\n  deleteReview(reviewId: $reviewId)\n}\n    "])));
/**
 ...
 * });
 */
function useDeleteReviewMutation(baseOptions) {
    return ApolloReactHooks.useMutation(exports.DeleteReviewDocument, baseOptions);
}
exports.useDeleteReviewMutation = useDeleteReviewMutation;
exports.FetchGymsDocument = graphql_tag_1.default(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n    query FetchGyms {\n  gyms {\n    ...gymInfo\n  }\n}\n    ", ""], ["\n    query FetchGyms {\n  gyms {\n    ...gymInfo\n  }\n}\n    ", ""])), exports.GymInfoFragmentDoc);
/**
...
exports.GymDetailsDocument = graphql_tag_1.default(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n    query gymDetails($id: String) {\n  gymDetails(id: $id) {\n    owner_id: id\n    owner_first_name: first_name\n    owner_last_name: last_name\n    email\n    owner_photo_url: photo_url\n    gym {\n      ...gymInfo\n    }\n  }\n  gymReviews(gymId: $id) {\n    id\n    rating\n    text\n    date_created\n    creator {\n      id\n      first_name\n      last_name\n      photo_url\n    }\n  }\n  gymMemberships(gymId: $id) {\n    member {\n      id\n      first_name\n      last_name\n      photo_url\n    }\n  }\n  me {\n    id\n  }\n}\n    ", ""], ["\n    query gymDetails($id: String) {\n  gymDetails(id: $id) {\n    owner_id: id\n    owner_first_name: first_name\n    owner_last_name: last_name\n    email\n    owner_photo_url: photo_url\n    gym {\n      ...gymInfo\n    }\n  }\n  gymReviews(gymId: $id) {\n    id\n    rating\n    text\n    date_created\n    creator {\n      id\n      first_name\n      last_name\n      photo_url\n    }\n  }\n  gymMemberships(gymId: $id) {\n    member {\n      id\n      first_name\n      last_name\n      photo_url\n    }\n  }\n  me {\n    id\n  }\n}\n    ", ""])), exports.GymInfoFragmentDoc);
/**
...
exports.HelloDocument = graphql_tag_1.default(templateObject_17 || (templateObject_17 = __makeTemplateObject(["\n    query Hello {\n  hello\n}\n    "], ["\n    query Hello {\n  hello\n}\n    "])));
/**
 * __useHelloQuery__
 *
...
exports.LoginDocument = graphql_tag_1.default(templateObject_19 || (templateObject_19 = __makeTemplateObject(["\n    mutation Login($username: String!, $password: String!) {\n  login(username: $username, password: $password) {\n    accessToken\n    user {\n      ...profile\n      preferences {\n        yoga\n        crossfit\n        bodybuilding\n        parkour\n        general\n        boxing\n      }\n      gym {\n        id\n        gym_name\n      }\n      ...alerts\n    }\n  }\n}\n    ", "\n", ""], ["\n    mutation Login($username: String!, $password: String!) {\n  login(username: $username, password: $password) {\n    accessToken\n    user {\n      ...profile\n      preferences {\n        yoga\n        crossfit\n        bodybuilding\n        parkour\n        general\n        boxing\n      }\n      gym {\n        id\n        gym_name\n      }\n      ...alerts\n    }\n  }\n}\n    ", "\n", ""])), exports.ProfileFragmentDoc, exports.AlertsFragmentDoc);
/**
...
exports.LogoutDocument = graphql_tag_1.default(templateObject_20 || (templateObject_20 = __makeTemplateObject(["\n    mutation Logout {\n  logout\n}\n    "], ["\n    mutation Logout {\n  logout\n}\n    "])));
/**
...
exports.MeDocument = graphql_tag_1.default(templateObject_21 || (templateObject_21 = __makeTemplateObject(["\n    query Me {\n  me {\n    ...profile\n    preferences {\n      yoga\n      crossfit\n      bodybuilding\n      parkour\n      general\n      boxing\n    }\n    gym {\n      id\n      gym_name\n    }\n    ...alerts\n  }\n}\n    ", "\n", ""], ["\n    query Me {\n  me {\n    ...profile\n    preferences {\n      yoga\n      crossfit\n      bodybuilding\n      parkour\n      general\n      boxing\n    }\n    gym {\n      id\n      gym_name\n    }\n    ...alerts\n  }\n}\n    ", "\n", ""])), exports.ProfileFragmentDoc, exports.AlertsFragmentDoc);
/**
 * __useMeQuery__
 *
...
exports.MyGymDocument = graphql_tag_1.default(templateObject_22 || (templateObject_22 = __makeTemplateObject(["\n    query MyGym {\n  myGym {\n    ...gymInfo\n  }\n}\n    ", ""], ["\n    query MyGym {\n  myGym {\n    ...gymInfo\n  }\n}\n    ", ""])), exports.GymInfoFragmentDoc);
/**
 * __useMyGymQuery__
 *
...
exports.UserProfileDocument = graphql_tag_1.default(templateObject_24 || (templateObject_24 = __makeTemplateObject(["\n    query userProfile($userId: String!) {\n  getUser(id: $userId) {\n    ...profile\n    preferences {\n      yoga\n      crossfit\n      bodybuilding\n      parkour\n      general\n      boxing\n    }\n    gym {\n      id\n      gym_name\n    }\n  }\n  userMemberships(userId: $userId) {\n    gym {\n      id\n      gym_name\n      location\n      type\n      photo_urls\n    }\n  }\n  userReviews(userId: $userId) {\n    rating\n    text\n    gym {\n      id\n      gym_name\n    }\n  }\n}\n    ", ""], ["\n    query userProfile($userId: String!) {\n  getUser(id: $userId) {\n    ...profile\n    preferences {\n      yoga\n      crossfit\n      bodybuilding\n      parkour\n      general\n      boxing\n    }\n    gym {\n      id\n      gym_name\n    }\n  }\n  userMemberships(userId: $userId) {\n    gym {\n      id\n      gym_name\n      location\n      type\n      photo_urls\n    }\n  }\n  userReviews(userId: $userId) {\n    rating\n    text\n    gym {\n      id\n      gym_name\n    }\n  }\n}\n    ", ""])), exports.ProfileFragmentDoc);
/**
...
exports.UsersDocument = graphql_tag_1.default(templateObject_25 || (templateObject_25 = __makeTemplateObject(["\n    query Users {\n  users {\n    ...profile\n  }\n}\n    ", ""], ["\n    query Users {\n  users {\n    ...profile\n  }\n}\n    ", ""])), exports.ProfileFragmentDoc);
/**
 * __useUsersQuery__
 *
