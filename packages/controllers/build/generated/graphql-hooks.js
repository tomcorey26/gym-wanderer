...
exports.GymDetailsDocument = graphql_tag_1.default(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    query gymDetails($id: String) {\n  gymDetails(id: $id) {\n    first_name\n    last_name\n    email\n    gym {\n      gym_name\n      description\n      membership_cost\n      location\n      equipment\n      photo_urls\n      coordinates {\n        lat\n        lng\n      }\n      type\n    }\n  }\n}\n    "], ["\n    query gymDetails($id: String) {\n  gymDetails(id: $id) {\n    first_name\n    last_name\n    email\n    gym {\n      gym_name\n      description\n      membership_cost\n      location\n      equipment\n      photo_urls\n      coordinates {\n        lat\n        lng\n      }\n      type\n    }\n  }\n}\n    "])));
/**
...
exports.HelloDocument = graphql_tag_1.default(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n    query Hello {\n  hello\n}\n    "], ["\n    query Hello {\n  hello\n}\n    "])));
/**
 * __useHelloQuery__
 *
...
exports.LoginDocument = graphql_tag_1.default(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n    mutation Login($email: String!, $password: String!) {\n  login(email: $email, password: $password) {\n    accessToken\n    user {\n      id\n      email\n      first_name\n      last_name\n      username\n      birthday\n      preferences {\n        yoga\n        crossfit\n        bodybuilding\n        parkour\n        general\n        boxing\n      }\n      gym {\n        id\n        gym_name\n      }\n    }\n  }\n}\n    "], ["\n    mutation Login($email: String!, $password: String!) {\n  login(email: $email, password: $password) {\n    accessToken\n    user {\n      id\n      email\n      first_name\n      last_name\n      username\n      birthday\n      preferences {\n        yoga\n        crossfit\n        bodybuilding\n        parkour\n        general\n        boxing\n      }\n      gym {\n        id\n        gym_name\n      }\n    }\n  }\n}\n    "])));
/**
...
exports.LogoutDocument = graphql_tag_1.default(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n    mutation Logout {\n  logout\n}\n    "], ["\n    mutation Logout {\n  logout\n}\n    "])));
/**
...
exports.MeDocument = graphql_tag_1.default(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n    query Me {\n  me {\n    id\n    email\n    first_name\n    last_name\n    username\n    birthday\n    preferences {\n      yoga\n      crossfit\n      bodybuilding\n      parkour\n      general\n      boxing\n    }\n    gym {\n      id\n      gym_name\n    }\n  }\n}\n    "], ["\n    query Me {\n  me {\n    id\n    email\n    first_name\n    last_name\n    username\n    birthday\n    preferences {\n      yoga\n      crossfit\n      bodybuilding\n      parkour\n      general\n      boxing\n    }\n    gym {\n      id\n      gym_name\n    }\n  }\n}\n    "])));
/**
 * __useMeQuery__
 *
...
exports.MyGymDocument = graphql_tag_1.default(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n    query MyGym {\n  myGym {\n    ownerId\n    gym_name\n    description\n    membership_cost\n    location\n    coordinates {\n      lat\n      lng\n    }\n    isOpen\n    date_created\n  }\n}\n    "], ["\n    query MyGym {\n  myGym {\n    ownerId\n    gym_name\n    description\n    membership_cost\n    location\n    coordinates {\n      lat\n      lng\n    }\n    isOpen\n    date_created\n  }\n}\n    "])));
/**
 * __useMyGymQuery__
 *
...
exports.UsersDocument = graphql_tag_1.default(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n    query Users {\n  users {\n    id\n    email\n    birthday\n    first_name\n    last_name\n  }\n}\n    "], ["\n    query Users {\n  users {\n    id\n    email\n    birthday\n    first_name\n    last_name\n  }\n}\n    "])));
/**
 * __useUsersQuery__
 *
